...
| Layer                | Technology                                                    |
| -------------------- | ------------------------------------------------------------- |
| **3D Rendering**     | [Three.js](https://threejs.org/) r177+                        |
| **Animation**        | [@tweenjs/tween.js](https://github.com/tweenjs/tween.js) 21.x |
| **UI Framework**     | React 19 + TypeScript 6                                       |
| **Styling**          | Tailwind CSS v4                                               |
| **Build Tool**       | Vite 8                                                        |
| **State Management** | Zustand 5                                                     |
| **AI Backend**       | LM Studio (local, OpenAI-compatible REST API)                 |
| **Testing**          | Vitest 4 (unit), Playwright 1.6x (E2E)                        |
